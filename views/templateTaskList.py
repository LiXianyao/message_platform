...
templateTaskManagement = Blueprint('templateTaskManagement'
                                  ,__name__
...
"""
@templateTaskManagement.route('/templateTaskManagement/',methods=['GET'])
def gettemplateTaskManagement():
    return render_template('templateTaskManagement.html')

@templateTaskManagement.route('/templateTaskManagement/tableList/',methods=['POST'])
...
def query_templateTask_join_redisServer(filter_str):
...
"""
@templateTaskManagement.route('/templateTaskManagement/plus/',methods=['POST'])
...
为已有的功能组添加具体的功能，新功能不可以与同一功能组下的功能同名
"""
@templateTaskManagement.route('/templateTaskManagement/edit/',methods=['POST'])
def templateTaskManagement_edit():
...
为已有的功能组添加具体的功能，新功能不可以与同一功能组下的功能同名
"""
@templateTaskManagement.route('/templateTaskManagement/delete/',methods=['POST'])
